...
- Added [doc/project-structure.md](doc/project-structure.md), explaining the claude-project-structure pattern, how this repo applies it, and how to reuse it elsewhere. Linked from the README TOC.
